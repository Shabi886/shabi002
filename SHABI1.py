...
\033[1;93m          /-/    /-/        /-/    /-/          \-\  /-/           /-/      /-/
a033[1;93m /-//-//-/  /-/         /-/    /-/              \-\ /-//-//-//-/    /-//-//-/
\033[1;91m--> INSTAGRAM  :- SHABI007
\033[1;92m--> FACEBOOK   :- S H A BI
\033[1;93m--> YOUTUBE    :- SHABI GAMING
\033[1;95m--> NO       :- WHATSAPP 03142188151
...
CorrectUsername = "SHABI007"
CorrectPassword = "SHABI007"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:SHABI
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-open https://www.facebook.com/mastarameer.masteerameer)
    else:
        print "\033[1;91mWrong Username"
        os.system('xdg-open https://www.facebook.com/majeed.ullah.73550)
...
def login():
	...
	print "1.\x1b[1;95mLogin  Facebook  "
        time.sleep(0.05)
        print "2.\x1b[1;95mDownload Get Access Token App Free"
        time.sleep(0.05)
